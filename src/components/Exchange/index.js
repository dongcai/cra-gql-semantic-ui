...
class ExchangeRates extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    if (this.state.pageId !== prevState.pageId &&
      this.state.pageId === ((this.state.offset + this.state.limit) / this.state.pageSize -1)
    ){
